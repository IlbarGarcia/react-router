 ...
 (   
    <div className="card-container">
      <div className="header">
        ...
        {/*<a href={`/cursos/${id}`}>
            cuando le demos click en la imagen nos va a dirigir a la direecion que tenemos en href, pero si lo usamos asi recarga la pagina , para evitar esto usamos la etiqueta link que se encuntra abajo  
